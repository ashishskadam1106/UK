...
public partial class Form_FinishedGradingEvents : System.Web.UI.Page
{
    ...
    private void Delete_Event(int EventHeaderId_ToDelete)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "alert('Event Deleted successfully');window.location='Form_FinishedGradingEvents.aspx'", true);
    ...
    private void Fill_GradingEvent()
    {
        try
        {
            ...
            cmd.CommandText = "Select EventHeaderId,EventLabel,Convert(varchar,EventDate,103)EventDate,B.EventKyu_Name from tbl_EventHeader E inner join tbl_EventKyuMaster B  ON E.EventKyuId=B.EventKyu_Id Where IsDeleted=0  and  EventDate<=GetDate()";
            ...
            if (dr.HasRows)
            {
                ...
                {
                    UnreadText += "<tr>";
                    UnreadText += "     <td class=\"c-grid-col-size-250\"><div class=\"c-grid-label-left\"><span>" + dr["EventLabel"].ToString() + "</span></div></td>";
                    UnreadText += "     <td class=\"c-grid-col-size-100\"><div class=\"c-grid-label-left\"><span>" + Convert.ToDateTime(dr["EventDate"]).ToString("dd/MM/yyyy") + "</span></div></td>";
                    UnreadText += "     <td class=\"c-grid-col-size-100\"><div class=\"c-grid-label-left\"><span>" + dr["EventKyu_Name"].ToString() + "</span></div></td>";
                    UnreadText += "<td  class=\"c-grid-col-size-100\"><div><a class=\"fa fa-eye inline-icon-size-large \" title=\"View Event Details\" href=\"Form_EventDetail.aspx?ID=" + encrypt(dr["EventHeaderId"].ToString()) + "&Call=" + encrypt("2") + "\"><span><span></a> <a class=\"fa fa-pencil-square-o inline-icon-size-large\" title=\"Live Event Details\" href=\"Form_LiveEventDetails.aspx?ID=" + encrypt("0") + "&Call=" + encrypt("1") + "\"><span><span></a> <a class=\"fa fa-sticky-note-o inline-icon-size-large\" title=\"Delete Event\" onclick=\"return confirm('Are you sure?')\" href=\"Form_FinishedGradingEvents.aspx?ID=" + encrypt(dr["EventHeaderId"].ToString()) + "\"><span><span></a> <a class=\"fa fa-print inline-icon-size-large\" title=\"Print Certificates\" href=\"Form_PrintCertificateForKyu.aspx?ID=" + encrypt(dr["EventHeaderId"].ToString()) + "&Call=" + encrypt("2") + "&StudentId=" + encrypt("0") + "\"><span><span></a> </div> <div><a target=\"_blank\" rel\"><span><span></a></div> </td>";
                    UnreadText += "</tr>";
                    UnreadText += "</tr>";
    ...
    {
        ScriptManager.RegisterStartupScript(this, this.GetType(), "Openwindow", "window.open('Reports/Form_PrintFinishedGradingEvents.aspx');", true);
    }
