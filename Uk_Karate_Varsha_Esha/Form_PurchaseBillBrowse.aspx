<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_PurchaseBillBrowse.aspx.cs" Inherits="Form_PurchaseBillBrowse" %>
            ...
            <div class="content-wrapper">
                <div class="box box-solid box-info c-border-blueish c-container-box" style="margin-bottom: 0">
                    ...
                    <div class="box-header c-box-blueish  with-border">
                        <asp:Label ID="Lbl_Header" runat="server" CssClass="box-title" Text="Purchase browse"></asp:Label>
                    </div>
                        ...
                        <div class="col-md-12 col-md-offset-2 c-button-box-2">
                            ...
                            <div class="col-md-10 no-padding">
                                <div class="col-md-4 c-btn-widht-25">
                                    <asp:Button ID="Btn_Search" runat="server" Text="Search" CssClass="btn bg-purple c-bg-blueish btn-block  btn-flat c-with-shadow" formnovalidate="" OnClick="Btn_Refresh_Click" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 c-inline-space">
                            <div class="table-responsive no-padding c-grid-container c-inline-space">
                                <div>
                                    ...
                                    <table class="table" id="Gv_PurchaseBrowse">
                                        <thead>
                                        ...
                                        <tbody id="PurchaseBrowse_Body" runat="server"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
