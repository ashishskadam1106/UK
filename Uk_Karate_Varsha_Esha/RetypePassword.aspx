<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetypePassword.aspx.cs" Inherits="RetypePassword" %>
        ...
        <div class="wrapper" style="background-color: white;">
            ...
            <div class="login-box" >
                ...
                <div  class="login-logo C-LoginText">
                    ...
                    <a href="#" style=" color:white" class="c-product-title">Retype Password</a>
                ...
                <div class="login-box-body" style="padding-top:0">
                   <br />
                    ...
                    <div class="form-group has-feedback">
                        <asp:TextBox runat="server" ID="Tb_ConfirmPassword" TextMode="Password" CssClass="form-control c-with-bottom-border" required="required" oninvalid="this.setCustomValidity('Please enter password')"  oninput="setCustomValidity('')" placeholder="ConfirmPassword" />
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 C-MinCol">
                            <asp:Button ID="Btn_Login" runat="server" class="btn bg-purple c-bg-blueish btn-block btn-flat c-with-shadow" Text="ChangePassword" OnClick="Btn_Login_Click"></asp:Button>
                        </div>
                    </div>
                    <p></p>
