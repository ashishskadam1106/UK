<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_PurchaseBillAddUpdate.aspx.cs" Inherits="Form_PurchaseBillAddUpdate" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        function CalculateTotal() {
            ...
            var tbl = $("[id$=Gv_PurchaseBillDetail]");
            ...
            <div class="content-wrapper">
                <div class="box box-solid box-info c-border-blueish c-container-box" style="margin-bottom: 0">
                    <div class="box-header c-box-blueish-new with-border">
                        <asp:Label runat="server" ID="Lbl_Heading" CssClass="box-title" Text="Add Purchase Bill"></asp:Label>
                    </div>
                    <div class="box-body c-padding-top-2">
                        <div class="col-md-12 c-inline-space">
                            <div class="col-md-2 c-col-size-14 c-label-1">
                                <asp:Label ID="Lbl_Bill_No" runat="server" CssClass="Label" Text="Bill No."></asp:Label>
                            </div>
                            <div class="col-md-10 no-padding c-col-size-86">
                                <div class="col-md-4 c-col-size-40">
                                    <asp:TextBox ID="Tb_Bill_No" runat="server" CssClass="form-control" placeholder="Auto Generated Bill No." Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col-md-4 c-col-size-20 c-label-1 c-padding-left-1">
                                    <asp:Label ID="Lbl_Bill_Date" runat="server" CssClass="Label" Text="Bill Date *"></asp:Label>
                                </div>
                                <div class="col-md-4 c-col-size-40">
                                    <div class="input-group date">
                                        ...
                                        <asp:TextBox runat="server" CssClass="form-control"
                                            ID="Dp_Bill_Date" data-date-format="dd/mm/yyyy" placeholder="Bill Date"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <asp:UpdatePanel runat="server" ID="Upnl1">
                            <ContentTemplate>
                                <div class="col-md-12 c-inline-space">
                                    <div class="col-md-2 c-col-size-14 c-label-1">
                                        <asp:Label ID="Label1" runat="server" CssClass="Label" Text="Supplier Name"></asp:Label>
                                    </div>
                                    <div class="col-md-10 no-padding c-col-size-86">
                                        <div class="col-md-4 c-col-size-40">
                                            <asp:DropDownList ID="Dd_SupplierName" runat="server" CssClass="form-control select2" DataValueField="SupplierId" DataTextField="SupplierName" AutoPostBack="true" OnSelectedIndexChanged="Dd_SupplierName_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-md-4 c-col-size-20 c-label-1 c-padding-left-1">
                                            <asp:Label ID="Lbl_PoNo" runat="server" CssClass="Label" Text="Purchase order No *"></asp:Label>
                                        </div>
                                        <div class="col-md-4 c-col-size-40">
                                            <asp:DropDownList ID="Dd_PurchaseOrderNo" runat="server" DataValueField="PurchaseOrderHeaderId" DataTextField="PurchaseOrderNumber" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="Dd_PurchaseOrderNo_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 c-inline-space">
                            ...
                            <ContentTemplate>
                                <div class="col-md-12">
                                    <div class="table-responsive no-padding c-grid-container c-inline-space">
                                        <asp:GridView runat="server" ID="Gv_PurchaseBillDetail" CssClass="table"
                                            ...
                                            OnRowCancelingEdit="Gv_PurchaseBillDetail_RowCancelingEdit"
                                            OnRowCommand="Gv_PurchaseBillDetail_RowCommand"
                                            OnRowUpdating="Gv_PurchaseBillDetail_RowUpdating"
                                            AllowPaging="true" PageSize="15"
                                            PagerStyle-CssClass="c-paging"
                                            OnPageIndexChanging="Gv_PurchaseBillDetail_PageIndexChanging"
                                            OnRowDataBound="Gv_PurchaseBillDetail_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Quantity">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="Tb_Quantity" onkeypress="return isNumber(event)" CssClass="form-control" placeholder="Purchase Quantity" Text='<%#Eval("Quantity","{0:0.00}")%>' Width="60" ></asp:TextBox>
                                                    </ItemTemplate>

                                                    <FooterTemplate>
                                                        <asp:TextBox runat="server" ID="Tb_Quantity" onkeypress="return isNumber(event)" Text="0.00" CssClass="form-control" placeholder="Purchase Quantity" Width="60"></asp:TextBox>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
