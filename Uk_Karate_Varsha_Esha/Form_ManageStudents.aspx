<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_ManageStudents.aspx.cs" Inherits="Form_ManageStudents" %>
            ...
            <div class="content-wrapper">
                <div class="box box-solid box-info c-border-blueish c-container-box" style="margin-bottom: 0">
                    ...
                    <div class="box-header c-box-blueish  with-border">
                        <asp:Label ID="Lbl_Header" runat="server" CssClass="box-title" Text="Manage Students"></asp:Label>
                    </div>
                    <div class="box-body c-padding-top-2">
                        <asp:HiddenField ID="Hf_ManageStudentNoteId" runat="server" Value="0" />
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4 c-btn-widht-20">
                                <asp:Button runat="server" ID="Btn_DeleteStudent" CssClass="btn bg-purple c-bg-blueish btn-block  btn-flat c-with-shadow" Text="Delete Selected Students" OnClick="Btn_DeleteStudent_Click" OnClientClick="return confirm('Are you sure you want to deleted these students?')" />
                            </div>
                            <div class="col-md-4 c-btn-widht-20">
                                <asp:Button runat="server" ID="Btn_MoveToDorement" CssClass="btn bg-purple c-bg-blueish btn-block  btn-flat c-with-shadow" Text="Move To Dorement" OnClick="Btn_MoveToDorement_Click" />
                            </div>
                        </div>
                            ...
                            <div class="col-md-10 no-padding c-col-size-86">
                                ...
                                <div class="col-md-4 c-col-size-40">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <asp:TextBox runat="server" CssClass="form-control"
                                            ID="Tb_ToDate" data-date-format="dd/mm/yyyy"  AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
