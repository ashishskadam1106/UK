<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_FinishedGradingEvents.aspx.cs" Inherits="Form_FinishedGradingEvents" %>
            ...
            <div class="content-wrapper">
                <div class="box box-solid box-info c-border-blueish c-container-box" style="margin-bottom: 0">
                    ...
                    <div class="box-header c-box-blueish  with-border">
                        <asp:Label ID="Lbl_Header" runat="server" CssClass="box-title" Text="Finished Grading Event"></asp:Label>
                    </div>
