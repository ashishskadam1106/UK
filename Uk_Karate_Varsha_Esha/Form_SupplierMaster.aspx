<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_SupplierMaster.aspx.cs" Inherits="Form_SupplierMaster" %>
                    ...
                    <div class="box-body c-padding-top-2">
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="table-responsive no-padding c-grid-container c-inline-space">
                                <asp:GridView runat="server" ID="Gv_Suppliers" CssClass="table"
                                    ...
                                    OnPageIndexChanging="Gv_Suppliers_PageIndexChanging"
                                    OnSelectedIndexChanged="Gv_Suppliers_SelectedIndexChanged">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Supplier Name">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_Name" Text='<%#Eval("SupplierName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Address">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_Address" Text='<%#Eval("SupplierAddress") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Mobile">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_Mobile" Text='<%#Eval("ContactMobile") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
