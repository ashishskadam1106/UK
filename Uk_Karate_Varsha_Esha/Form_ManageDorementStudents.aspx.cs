...
public partial class Form_ManageDorementStudents : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    //UnreadText += "     <input type=\"hidden\" name=\"HfStudentIdByName"+dr["StudentId"].ToString()+"\" id=\"HfStudentId"+dr["StudentId"].ToString()+"\" value=\""+dr["StudentId"].ToString()+"\">";
                    UnreadText += "     <td class=\"c-grid-profile-pic\"><img src=\"" + dr["ImageFilePath"].ToString() + "\" class=\"img-circle\" alt=\"User Image\" height=\"100\" width=\"100\"></td>";
                    //UnreadText += "     <td class=\"c-grid-col-size-275\"><div><span class=\"c-grid-label-3\">" + dr["FullName"].ToString() + "</span><br/><span class=\"c-grid-label-1\">" + dr["MobileNumber"].ToString() + "<span></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[E]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + dr["EmailId"].ToString() + " </span></div></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[A]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + dr["StudentAddress"].ToString() + " </span></div></div> </td>";
                    UnreadText += "     <td class=\"c-grid-col-size-275\"><div><span class=\"c-grid-label-3\">" + dr["FullName"].ToString() + "</span></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[D]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + Convert.ToDateTime(dr["MembershipDate"].ToString()).ToString("dd/MM/yyyy") + " </span></div></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[M]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + dr["MobileNumber"].ToString() + " </span></div></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[E]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + dr["EmailId"].ToString() + " </span></div></div> <div class=\"col-md-12 no-padding c-inline-space\"> <div class=\"col-md-2 c-col-size-14 no-padding\"><span>[A]</span></div> <div class=\"col-md-10 c-col-size-86 no-padding c-padding-left-1\"> <span>" + dr["StudentAddress"].ToString() + " </span></div></div> </td>";
                    ...
                    UnreadText += "<td  class=\"c-grid-col-size-100\"><div><a class=\"fa fa-eye inline-icon-size-large\" title=\"View Student Details\" href=\"Form_StudentRegistration.aspx?ID=" + encrypt(dr["StudentId"].ToString()) + "&Call=" + encrypt("2") + "\"><span><span></a>  <a class=\"fa fa-sticky-note-o inline-icon-size-large\" title=\"Notes\" href=\"Form_StudentRegistration.aspx?ID=" + dr["StudentId"].ToString() + "\"><span><span></a> </div> <div><a class=\"fa fa-print inline-icon-size-large\" href=\"Form_StudentRegistration.aspx?ID=" + dr["StudentId"].ToString() + "\"><span><span></a><a class=\"fa fa-print inline-icon-size-large\" href=\"Form_StudentRegistration.aspx?ID=" + dr["StudentId"].ToString() + "\"><span><span></a></div> </td>";

                    //UnreadText += "     <td class=\"c-grid-col-size-300\"><div class=\"col-md-12 no-padding\"><div class=\"col-md-2 c-col-size-14 no-padding\"><span>[E]</span></div><div class=\"col-md-10 c-col-size-86 no-padding\"><span>" + dr["DojoCode"].ToString() + "</span></div></div>  <div class=\"col-md-12 no-padding\"><div class=\"col-md-2 c-col-size-14 no-padding\"><span>[M]</span></div><div class=\"col-md-10 c-col-size-86 no-padding\"><span>" + dr[5].ToString() + "</span></div></div> </td>";
                    //UnreadText += "     <td class=\"c-grid-col-size-100\"><a class=\"btn btn-primary bg-purple c-bg-blueish btn-block  btn-flat\" href=\"Form_EmployeeMaster_AddUpdate.aspx?ID=" + dr[8].ToString() + "\"><span>Edit<span></a></td>";
    ...
    protected void Btn_DeleteStudent_Click(object sender, EventArgs e)
    {
        ...
        if (!String.IsNullOrEmpty(StudentIds))
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "alert('Selected students moved successfully');window.location='Form_ManageDorementStudents.aspx';", true);
            //Fill_StudentDetail(0);
        }
    ...
    protected void Btn_MoveToManageStudent_Click(object sender, EventArgs e)
    {
        String StudentIds = Hf_SelectedStudentIds.Value.ToString();
        if (!String.IsNullOrEmpty(StudentIds))
        {
            ...
            for (int i = 0; i < SplitStudentIds.Length; i++)
            {
                ...
                {
                    //cmd.CommandText = "USP_StudentISDormentStudent";
                    cmd.CommandText = "USP_StudentMoveToManage";
                    cmd.Connection = con;
                    cmd.CommandType = CommandType.StoredProcedure;

                    cmd.Parameters.AddWithValue("@StudentId", Convert.ToInt32(StudentId));
                    cmd.Parameters.AddWithValue("@ReActivatedBy", UserName);
                    cmd.Parameters.AddWithValue("@ReAtcivateDate", CurrentUtc_IND);
            ...
            Hf_SelectedStudentIds.Value = "";
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "alert('Selected students Restored successfully');window.location='Form_ManageDorementStudents.aspx';", true);
            //Fill_StudentDetail(0);
        }
    }
