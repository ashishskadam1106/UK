<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_ClassMaster.aspx.cs" Inherits="Form_ClassMaster" %>
                       ...
                       <%--gridview start--%>
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="table-responsive no-padding c-grid-container c-inline-space">
                                <asp:GridView runat="server" ID="Gv_ClassMaster" CssClass="table"
                                    ...
                                    PagerStyle-CssClass="c-paging" OnPageIndexChanging="Gv_ClassMaster_PageIndexChanging"
                                    AutoGenerateColumns="false" OnSelectedIndexChanged="Gv_ClassMaster_SelectedIndexChanged">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Class">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_ClassName" Text='<%#Eval("Class") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Class Code" HeaderStyle-CssClass="c-col-size-15" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_ClassCode" Text='<%#Eval("ClassCode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
