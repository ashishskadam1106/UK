<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_AlertEventMaster.aspx.cs" Inherits="Form_AlertEventMaster" %>
            ...
            <div class="content-wrapper">
                <div class="box  box-solid box-info c-border-blueish c-container-box"  style="margin-bottom:0">
                    <div class="box-header c-box-blueish  with-border" >
                        <h3 class="box-title">Alert Event Master</h3>
                    </div>
                    <div class="box-body">
                       <%--gridview start--%>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="table-responsive no-padding c-grid-container c-inline-space">
                                <asp:GridView runat="server" ID="Gv_AlertEventMaster" CssClass="table"
                                    ...
                                    DataKeyNames="AlertEventId"
                                    AllowPaging="true" PageSize="15"
                                    PagerStyle-CssClass="c-paging" OnPageIndexChanging="Gv_AlertEventMaster_PageIndexChanging"
                                    AutoGenerateColumns="false" OnSelectedIndexChanged="Gv_AlertEventMaster_SelectedIndexChanged">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Event Title">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_EventTitle" Text='<%#Eval("EventTitle") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                       ...
                                       <%-- <asp:TemplateField HeaderText="Schedule">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="Lbl_ScheduleMaster" Text='<%#Eval("ScheduleName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
