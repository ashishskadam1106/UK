<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_ClassMaster_AddUpdate.aspx.cs" Inherits="Form_ClassMaster_AddUpdate" %>
            ...
            <div class="content-wrapper">
                <div class="box box-solid box-info c-border-blueish c-container-box" style="margin-bottom: 0">
                    <div class="box-header c-box-blueish-new with-border">
                        <asp:Label runat="server" ID="Lbl_Heading" CssClass="box-title" Text="Add Class"></asp:Label>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10 no-padding c-col-size-86">
                                <div class="col-md-4 c-col-size-40">
                                    <asp:TextBox ID="Tb_ClassName" runat="server" CssClass="form-control c-tb-noresize" placeholder="Class Name" required="required"
                                        oninvalid="this.setCustomValidity('Please enter Class name')" oninput="this.setCustomValidity('')"></asp:TextBox>
                                </div>
                                <div class="col-md-4 c-col-size-20 c-label-1 c-padding-left-1">
                                    <asp:Label ID="Label2" runat="server" Text="Class Code"></asp:Label>
                                </div>
                                <div class="col-md-4 c-col-size-40">
                                    <asp:TextBox ID="Tb_ClassCode" runat="server" CssClass="form-control c-tb-noresize" placeholder="Class Code"></asp:TextBox>
                                </div>
                            </div>
                        </div>
