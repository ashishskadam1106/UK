...
public partial class Reports_Form_PrintDateWisePayment : System.Web.UI.Page
{
    ...
    private void Fill_Report()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_DateWisePayment.rdlc");
        DS_DateWisePayment dsIncidents = GetData();
        ReportDataSource datasource = new ReportDataSource("DS_DateWisePayment", dsIncidents.Tables[0]); //name of dataset
    ...
    private DS_DateWisePayment GetData()
    {
        cmd = new SqlCommand("USP_Report_DateWisePayment");
        using (con = new SqlConnection(str))
        {
            using (da = new SqlDataAdapter(cmd))
            {
                ...
                using (DS_DateWisePayment Bill = new DS_DateWisePayment())
                {
                    da.Fill(Bill, "USP_Report_DateWisePayment"); //Name of dataTable
                    return Bill;
                }
            }
        }
