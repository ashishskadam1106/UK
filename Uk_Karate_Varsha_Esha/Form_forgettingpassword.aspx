<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form_forgettingpassword.aspx.cs" Inherits="Form_forgettingpassword" %>
        ...
        <div class="wrapper" style="background-color: white;">
            ...
            <div class="login-box" >
                ...
                <div  class="login-logo C-LoginText">
                    ...
                    <a href="#" style=" color:white" class="c-product-title">Forgot Password </a>
                ...
                <div class="login-box-body" style="padding-top:0">
                   <br/>
                    ...
                    <div class="form-group has-feedback">
                        <asp:TextBox runat="server" ID="Tb_EmailId"  CssClass="form-control c-with-bottom-border" required="required" 
                            oninvalid="this.setCustomValidity('Please enter Email Id')" oninput="setCustomValidity('')" placeholder="Email Id" />
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <asp:TextBox runat="server" ID="Tb_UserName" CssClass="form-control c-with-bottom-border" required="required" oninvalid="this.setCustomValidity('Please enter UserName')"  oninput="setCustomValidity('')" placeholder="UserName" />
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                    </div>
                    <div class="row">
                        <div class="col-md-4 C-MinCol">
                            <asp:Button ID="Btn_Submit" runat="server" class="btn bg-purple c-bg-blueish btn-block btn-flat c-with-shadow" Text="Submit" OnClick="Btn_Submit_Click"></asp:Button>
                        </div>
                    </div>
                    <p></p>
